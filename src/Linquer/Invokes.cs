...
#pragma warning disable IDE0060 // Remove unused parameter
        ...
        private static NotSupportedException ToBeUsedInLinqExpressionsOnly() =>
            new NotSupportedException($"Invokes.{nameof(Invoke)} method should not be called, it is expected to be used in LINQ expressions only.");
